...
<body>
    ...
    <div class="container-fluid">
        ...
        <h1 class="mt-4 mb-4">Создать пользователя</h1>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="start_job_date" id="start_job_date">
            </div>
             <div class="form-group">
                <label for="end_job_date">Дата окончания работы:</label>
                <input type="date" class="form-control" name="end_job_date" id="end_job_date">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="role" id="role" required>
                    ...
                    <option value="storekeeper" {{ isset($user) && $user->role == 'storekeeper' ? 'selected' : '' }}>Кладовщик</option>
                    <option value="seller" {{ isset($user) && $user->role == 'seller' ? 'selected' : '' }}>Продавец</option>
                </select>
            </div>
            <div class="form-group">
           ...
           {{--  <div class="form-group">
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" name="is_active" id="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} @if(old('is_active')) checked @endif>
